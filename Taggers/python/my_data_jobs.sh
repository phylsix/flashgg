...
queue="8nh"
LM=/afs/cern.ch/work/w/wsi/private/CMSSW_8_0_8_patch1/src/flashgg/MetaData/work/jsons/Cert_271036-276811_13TeV_PromptReco_Collisions16_JSON.txt
version="000"
fggRunJobs.py --load data_jobs.json -d data_jobs_${version} -x cmsRun ../../Systematics/test/VHCSample_producer.py maxEvents=1000 -n 100 -q ${queue} -D -P useAAA=0 atIC=1 doFiducial=False lumiMask=${LM}
